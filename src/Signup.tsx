...
const Signup: React.FC<SignupProps> = ({ onSignup }) => {
    ...
    return (
        <div className={'SignUp'}>
            <h2>Sign up</h2>
            <input className={'padding'} type="text" placeholder="Username" value={username} onChange={e => setUsername(e.target.value)} />
            <input className={'padding'} type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} />
